 ...
 */
  ...
  updatePhysics: function() {
    //udate the ships angular velocities for rotation
    ...
    if (this.keyUp) {
      ...
      this.ship.force[0] -= this.speed * Math.sin(angle+Math.PI/2);
    ...
    for (i=0; i<this.removeObjs.length; i++)
    {
      ...
      // play random boom sound when an enemy explodes
